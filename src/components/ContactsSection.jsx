...
function ContactsSection() {
  return (
    <section key="contacts">
      ...
      <p><FaLinkedin style={{verticalAlign:'middle',marginRight:8,color:'#764ba2'}}/>LinkedIn: <a href="https://www.linkedin.com/in/artur-k-7b6718340/" target="_blank" rel="noopener noreferrer" style={{color:'#764ba2',textDecoration:'underline'}}>linkedin.com/rutra</a></p>
