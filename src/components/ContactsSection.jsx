...
function ContactsSection() {
  return (
    <section key="contacts">
      <h1>Contacts</h1>
      <p><FaEnvelope style={{verticalAlign:'middle',marginRight:8,color:'#667eea'}}/>Email: <a href="mailto:jeffthemail@gmail.com" style={{color:'#667eea',textDecoration:'underline'}}>jeffthemail@gmail.com</a></p>
